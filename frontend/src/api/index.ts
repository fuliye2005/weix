...
export const getBusinessConfig = () => api.get('/config/business')
export const updateBusinessConfig = (data: any) => api.put('/config/business', data)
...
export const diagnoseUia = () => api.get('/platform/uia/diagnose')
